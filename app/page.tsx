...
const OrderPage: React.FC = () => {
  ...
  // For now, manage order items locally
    ...
    <main className="container mx-auto p-4">
      ...
      <header className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold">
          <a href="/" aria-label="Página de inicio">Logo</a>
        </h1>
        <nav aria-label="Navegación principal">
          <menu className="flex space-x-4">
            <li><a href="#" aria-current="page" className="text-indigo-600">Inicio</a></li>
            <li><a href="#" className="hover:text-indigo-500">Órdenes</a></li>
            <li><a href="#" className="hover:text-indigo-500">Reportes</a></li>
            <li><a href="#" className="hover:text-indigo-500">Menú</a></li>
          </menu>
        </nav>
      </header>
      ...
      <section className="grid grid-cols-2 gap-4">
        ...
        <section aria-labelledby="table-config-heading">
          <h2 id="table-config-heading" className="text-lg font-semibold mb-2">Configuración de Mesa</h2>
